...
<ul>
    ...
    <li><?php echo $this->Html->link('List your completed tasks', array('controller' => 'tasks', 'action'=>'index','done')); ?></li>
    <li><?php echo $this->Html->link('List your pending tasks', array('controller' => 'tasks', 'action'=>'index', 'pending')); ?></li>
